...
void MX_ADC_Init(void)
{
  ...
  */
  ...
  AnalogWDGConfig.HighThreshold = POLKA_200;
...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA4     ------> ADC_IN4 
    */
    GPIO_InitStruct.Pin = CURRENT_Pin|AB_Pin|TEMP_ADC_Pin|VCC16V_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA4     ------> ADC_IN4 
    */
    HAL_GPIO_DeInit(GPIOA, CURRENT_Pin|AB_Pin|TEMP_ADC_Pin|VCC16V_Pin);
